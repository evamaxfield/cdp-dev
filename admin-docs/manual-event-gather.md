...
[Event Gather GitHub Action Page](https://github.com/evamaxfield/cdp-dev/actions/workflows/event-gather-pipeline.yml).
...
[Process Special Event GitHub Action Page](https://github.com/evamaxfield/cdp-dev/actions/workflows/process-special-event.yml).
