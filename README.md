...
[![Infrastructure Deployment Status](https://github.com/JacksonMaxfield/cdp-dev/workflows/Infrastructure/badge.svg)](https://github.com/JacksonMaxfield/cdp-dev/actions?query=workflow%3A%22Infrastructure%22)
[![Event Processing Pipeline](https://github.com/JacksonMaxfield/cdp-dev/workflows/Event%20Gather/badge.svg)](https://github.com/JacksonMaxfield/cdp-dev/actions?query=workflow%3A%22Event+Gather%22)
[![Event Index Pipeline](https://github.com/JacksonMaxfield/cdp-dev/workflows/Event%20Index/badge.svg)](https://github.com/JacksonMaxfield/cdp-dev/actions?query=workflow%3A%22Event+Index%22)
[![Web Deployment Status](https://github.com/JacksonMaxfield/cdp-dev/workflows/Web%20App/badge.svg)](https://JacksonMaxfield.github.io/cdp-dev)
[![Repo Build Status](https://github.com/JacksonMaxfield/cdp-dev/workflows/Build%20Main/badge.svg)](https://github.com/JacksonMaxfield/cdp-dev/actions?query=workflow%3A%22Build+Main%22)
...
This repo serves the municipality: **CDP Dev**
...
fs = GCSFileSystem(project="cdp-jackson-dev-077", token="anon")
...
in the
[admin-docs directory](https://github.com/JacksonMaxfield/cdp-dev/tree/main/admin-docs).
